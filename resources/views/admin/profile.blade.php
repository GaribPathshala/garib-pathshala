  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
            <!-- Upload image input-->
        <form action="{{ route('/DPupdate')}}" method="post" id="dpUpdate" name="dpUpdate" enctype="multipart/form-data">
            @csrf
                ...
                <div class="card shadow mb-3">
                    ...
                    <div class="card-body">
                        <div class="form-row">
                            ...
                            <div class="col">
                                <div class="form-group"><label for="last_name"><strong>Designation</strong></label><input class="form-control" type="text" value="{{ Auth::user()->designation }}" disabled></div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col">
...
@section('bottom-js')
<script src="{{ asset('assets/js/Bootstrap-Image-Uploader.js')}}"></script>
@endsection